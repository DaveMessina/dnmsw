...
int main (int argc, const char * argv[]) {
    ...
    // make this into parallelizable step by grabbing two seqs in one iteration
	...
	// get seqs
	strcpy(line1, lines[k]);
	strcpy(line2, lines[k+1]);
