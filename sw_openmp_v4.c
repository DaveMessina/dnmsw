...
int main (int argc, const char * argv[]) {
	...
	FILE *file;
	char lineAs[50][MAXLINELEN];
	char lineBs[50][MAXLINELEN];
...
// -------------------
// 1: serial code
// -- can speed up by not reallocating and filling and freeing matrix for each alignment, but instead reusing
//
// 2: parallelize main alignment loop trivially with OpenMP pragmas
//
// 3: parallelize matrix scoring function
// -- have to remove inter-iteration dependencies (i+1's)
//
// (4): parallelize matrix filling
// -- not that important, especially if I do number 1.
